...
public:
    ...
    WayPointCircle(WayPointItem *center, double radius, bool clockwise, MapGraphicItem *map, QColor color = Qt::green, bool dashed = false, int width = -1);
    WayPointCircle(HomeItem *center, double radius, bool clockwise, MapGraphicItem *map,  QColor color = Qt::green, bool dashed = false, int width = -1);
    int type() const;
